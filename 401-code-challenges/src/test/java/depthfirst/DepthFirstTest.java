...
public class DepthFirstTest {
    DepthFirst init = new DepthFirst();
    ...
    public void testDepthFirst() {
        List<GraphNode> nodeList = init.depthFirstWrapper(node1);
        ...
        assertEquals("The string constructed from the output of the depthFirst method should match the expected string.",
                expectedString,
                outputString);
    }
}